# -*- coding: utf-8 -*-
"""
Created on Tue Jul 28 19:27:30 2020
...
body_remove = ["Pair Coeffs", "Bond Coeffs", "Angle Coeffs", "Dihedral Coeffs"]
remove_starts = np.array([False, False, False, False], dtype=bool)
...
for index, line in enumerate(dat_file):
    ...
    if atoms_start == True and atoms_end == False:
        if line[0].isdigit():
            ...
            types_array[int(atoms_line[0]) - 1] = 3
            ...
            coords_array[:,2] = coords_array[:,2] * -1
    ...
    if atoms_end == True:
        if masses_start == False:
            mol_file.write("Masses\n\n")
            for x in range(1, num_atoms + 1):
